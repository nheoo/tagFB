<!DOCTYPE html>
<html>
<!-- ĐỪNG NGHỊCH NGỢM GÌ NHÉ HIHI -->
<head>

    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">

    <title>TagFRIEND | Nheoo</title>
...
<link rel="icon" type="image/x-icon" href="troll/favicon.ico">
<link rel="apple-touch-icon-precomposed" href="troll/troll-face-512-270545.png">
        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    ...
                    <img alt="image" class="img-circle" src="img/03.jpg" />
                             </span>
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold">Nheo ICTU</strong>
                             </span> <span class="text-muted text-xs block">KTMT_HTN<b class="caret"></b></span> </span> </a>
                ...
                <li class="active">
                    <a href="index.php"><i class="fa fa-diamond"></i> <span class="nav-label">Tag friend</span></a>
                </li>
                ...
                <div class="navbar-header">
                    ...
                    <form role="search" class="navbar-form-custom" method="post" action="#">
                        <div class="form-group">
                            <input type="text" placeholder="Chưa có gì đâu mà tìm :3" class="form-control" name="top-search" id="top-search">
                        </div>
                    </form>
                </div>
...
<section class="content">
		<div class="row">
			<div class="col-6 mx-auto">
				<h3 align="center" class="box-title">Tag FRIEND Facebook</h3>
				<form method="post">
					<div class="form-group">
						<label for="id_post">* Nhập ID bài đăng muốn tag(id video và ảnh đều được)</label>
						...
						<a href="http://bfy.tw/IQbc" target="_blank">Xem cách lấy ID bài viết facebook</a>
					</div>
					<div class="form-group">
						<label for="token">* Nhập token Facebook của bạn</label>
						...
						<a href="http://bfy.tw/IQbh" target="_blank">Xem cách lấy token full quyền</a>
					</div>
					<div class="form-group">
						<label for="text">* Comment kèm theo khi tag bạn bè</label>
						<input type="text" class="form-control" id="text" name="text" placeholder="VD: Like và share hộ mình nhé" value="<?php $value = isset($_POST["text"]) ? $_POST["text"] : "" ; echo $value ?>">
					</div>
					<div class="form-group">
						...
						<select name="select_type" id="select_type" class="form-control">
							...
							<option value="2" id="all_member_group" <?php if(isset($_POST["select_type"]) && $_POST["select_type"]==2) echo "selected" ?>>
								Tag tất cả thành viên nhóm (Max:1000 đừng tag nhiều quá không là bị khoá nhé)
							</option>
					...
					<div align="center">
						<button type="submit" name="submit" value="submit" class="btn btn-primary"> Bắt đầu tagFRIEND nào!</button>
					</div>
				</form>
			</div>
		</div>
...
?>
        ...
        <div id="footer">
            <div class="pull-right">
                Đừng Nghịch Ngợm <strong>Gì Nhé :3</strong>
            </div>
           <div>
                 <a href="http://fb.com/codyquang" target="_blank" title="Click">*    Quang Đăng HTN-K13    *</a>
            </div>
        </div>
...
console.log("%cQuang Đăng %s", css, 'hello Pro');
